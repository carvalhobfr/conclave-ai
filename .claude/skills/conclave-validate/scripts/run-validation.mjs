...
async function resolveCommand(repository) {
  ...
  return { command: "npx", prefix: ["--yes", "--package=conclave-ai@0.9.0", "conclave"] };
}
...
function validateReport(value) {
  ...
  if (![2, 3].includes(value.schemaVersion)) throw new Error("Unsupported Conclave validation schema version");
